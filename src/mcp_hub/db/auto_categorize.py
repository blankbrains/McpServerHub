...
CATEGORY_RULES = [
    (
        "browser",
        ["web", "browser", "search", "scraping", "crawl", "html", "http", "url", "link", "page"],
    ),  # noqa: E501
    (
        "database",
        [
    ...
    (
        "storage",
        ["file", "filesystem", "storage", "s3", "blob", "object storage", "fs ", "file system"],
    ),  # noqa: E501
    (
        "apis",
        ["api", "rest", "graphql", "integration", "webhook", "oauth", "auth", "authentication"],
    ),  # noqa: E501
    ("design", ["figma", "design", "ui", "ux", "sketch", "image", "photo", "video", "media"]),  # noqa: E501
    (
        "finance",
        ["finance", "payment", "stripe", "bank", "crypto", "blockchain", "wallet", "invoice"],
    ),  # noqa: E501
    ("maps", ["map", "maps", "geo", "location", "coordinate", "geocoding", "navigation"]),  # noqa: E501
    (
        "security",
        ["security", "vulnerability", "scan", "audit", "compliance", "encrypt", "certificate"],
    ),  # noqa: E501
    ("social-media", ["twitter", "reddit", "linkedin", "instagram", "social", "post", "tweet"]),
    (
        "productivity",
        ["calendar", "todo", "task", "note", "notion", "obsidian", "productivity", "organize"],
    ),  # noqa: E501
]
...
def auto_categorize(
    name: str, desc: str, tags: list[str] | None = None, existing_cats: list[str] | None = None
) -> list[str]:
    """根据名称、描述和标签自动推断分类。"""
